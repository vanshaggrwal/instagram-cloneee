...
function Sidenav() {
  return (
    <div className='Sidenav'>
        ...
        <div className="sidnav__buttons"><button className="sidenav__button">
            ...
            </button> <button className="sidenav__button">
            ...
            </button><div className="sidenav__more"><button className="sidenav__button"><MenuIcon />
            <span>More</span></button></div>
            </div></div>
